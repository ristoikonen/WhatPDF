...
//byte[] desample = decompressed_barr.Take(16).ToArray();
//byte[]? compressed_barr = QuickLZ.compress(barr, 1);
//byte[]? decompress_barr = QuickLZ.decompress(compressed_barr);

public class QuickLZ : IQuickLZ
{
